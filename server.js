...
app.use(
  "/stock_operations/product_command",
  require("./routes/stock_operations/product_command")
);
app.use(
  "/stock_operations/product_command_unit",
  require("./routes/stock_operations/product_command_unit")
);
app.use("/stock_operations/sale", require("./routes/stock_operations/sale"));
app.use(
  "/stock_operations/sale_unit",
  require("./routes/stock_operations/sale_unit")
);
